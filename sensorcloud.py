...
import time
import math
import pyowm #use pip install pyowm to download the python Open Weather Map library

AUTH_SERVER = "sensorcloud.microstrain.com"
owm_api_key = "your-sensorcloud-api-key-goes-here"
...
def uploadData(server, auth_token, device_id, sensor_name, channel_name,datalist=[], frequency):
	...
	for i in range(0,len(datalist)):
		packer.pack_hyper(datalist(i)(0))
		packer.pack_float(datalist(i)(1))  #generate value as a function of time
...
if __name__ == "__main__":
	...
	device_id = "OAPI0011828AALQM"
	key = "68a384f61afaa89ad422a91991e2cb769631c1df9b57bb77f73feed72546488d"
	...
	username = "your-Sensorcloud-username-goes-here"
	password = "your-Sensorcloud-password-goes-here"
	...
	addSensor(server, auth_token, device_id, sensor_name="S1", sensor_desc="API-TEST")
	
	#now add a channel to the sensor
	addChannel(server, auth_token, device_id, sensor_name="S1", channel_name="TestChannel")
	
	#now add some data to the channel
	uploadSinWave(server, auth_token, device_id, sensor_name="S1", channel_name="TestChannelData")
